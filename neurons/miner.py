    ...
    def __init__(self, config=None):
        ...
        self.model_manifest = build_local_model_manifest(
            ...
            implementation_files=[
                repo_root / "weights" / "gen13_tens8_165_hardened.ts",
            ...
            defaults={
                "model_name": "poker44_ml13tens8",
                "model_version": "13.8",
                "framework": "pytorch-torchscript",
                "license": "MIT",
                "repo_url": "https://github.com/tomkaba/poker44-miner-ml13tens8",
                "repo_commit": git_commit,
                "notes": "Gen13Tens8 neural network scorer (POT=165)",
                "open_source": True,
